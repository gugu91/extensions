...
Use `/pinet <action> [args]` for mesh lifecycle and broker operations. Legacy aliases such as `/pinet-start`, `/pinet-follow`, and `/pinet-free` remain registered for compatibility.
