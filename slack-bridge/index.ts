...
export default function (pi: ExtensionAPI) {
  ...
  pi.registerTool({
    ...
    promptGuidelines: [
      ...
      "Pick a fun, creative agent name based on your current task (e.g. 'Refactor Raccoon', 'Bug Squasher 3000', 'CSS Wizard'). Choose a matching emoji. Prefix EVERY Slack message with your emoji and name in parentheses, e.g. '🦝 (Refactor Raccoon) Just finished splitting the auth module.'",
